...
static const float smfact     = 0.5; /* factor of tiled clients [0.00..0.95] */
static const float shfact     = 0.5; /* factor of tertiary tiled clients [0.00..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_f,      toggle_grid,    {0} },
